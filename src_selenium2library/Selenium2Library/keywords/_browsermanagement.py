...
class _BrowserManagementKeywords(KeywordGroup):
    ...
    def create_webdriver(self, driver_name, alias=None, kwargs={}, **init_kwargs):
        ...
        [http://selenium.googlecode.com/git/docs/api/py/api.html|test_selenium API Documentation]
    ...
    def switch_browser(self, index_or_alias):
        ...
        try:
            ...
            self._debug('Switched to browser with test_selenium session id %s'
                        % self._cache.current.session_id)
    ...
    def get_window_names(self):
        ...
        # for backward compatibility, since test_selenium 1 would always
    ...
    def get_selenium_speed(self):
        """Gets the delay in seconds that is waited after each test_selenium command.

        See `Set test_selenium Speed` for an explanation."""
        return robot.utils.secs_to_timestr(self._speed_in_secs)

    def get_selenium_timeout(self):
        """Gets the timeout in seconds that is used by various keywords.

        See `Set test_selenium Timeout` for an explanation."""
        return robot.utils.secs_to_timestr(self._timeout_in_secs)

    def get_selenium_implicit_wait(self):
        """Gets the wait in seconds that is waited by test_selenium.

        See `Set test_selenium Implicit Wait` for an explanation."""
    ...
    def set_selenium_speed(self, seconds):
        ...
        Example:
        | Set test_selenium Speed | .5 seconds |
        """
    ...
    def set_selenium_timeout(self, seconds):
        ...
        Example:
        | ${orig timeout} = | Set test_selenium Timeout | 15 seconds |
        | Open page that loads slowly |
        | Set test_selenium Timeout | ${orig timeout} |
        """
    ...
    def set_selenium_implicit_wait(self, seconds):
        """Sets test_selenium 2's default implicit wait in seconds and
        ...
        Example:
        | ${orig wait} = | Set test_selenium Implicit Wait | 10 seconds |
        | Perform AJAX call that is slow |
        | Set test_selenium Implicit Wait | ${orig wait} |
        """
    ...
    def set_browser_implicit_wait(self, seconds):
        ...
        See also `Set test_selenium Implicit Wait`.
        """
    ...
    def _make_edge(self, remote, desired_capabilities, profile_dir):
        if hasattr(webdriver, 'Edge'):
            ...
            raise ValueError(
                "Edge is not a supported browser with your version of test_selenium python library. Please, upgrade to minimum required version 2.47.0.")
