...
// Give the init function the jQuery prototype for later instantiation
    ...
    jQuery.extend({
        ...
        // See test_selenium2library/unit/core.js for details concerning isFunction.
...
// The value/s can be optionally by executed if its a function
    ...
    (function () {
        ...
        // Can't get basic test_selenium2library support
        if (!all || !all.length || !a) {
            return;
        }
...
// querying by getElementById (and provide a workaround)
        ...
        (function () {
            ...
            div.innerHTML = "<div class='test_selenium2library e'></div><div class='test_selenium2library'></div>";
