...
class Selenium2Library(
    ...
    Selenium2Library uses the test_selenium 2 (WebDriver) libraries internally to control a web browser.
    See http://seleniumhq.org/docs/03_webdriver.html for more information on test_selenium 2
    and WebDriver.
    ...
    *Using webelements*
    ...
    `Set test_selenium Timeout` keyword. The same timeout also applies to
    ...
    def __init__(self,
        ...
        It can be later set with `Set test_selenium Timeout`.

        'implicit_wait' is the implicit timeout that test_selenium waits when
        looking for elements.
        It can be later set with `Set test_selenium Implicit Wait`.
