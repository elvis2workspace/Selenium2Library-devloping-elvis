...
class ElementFinderTests(unittest.TestCase):
    ...
    def test_find_with_locator_with_apos(self):
        finder = ElementFinder()
        browser = mock()
        finder.find(browser, "test_selenium2library '1'")
        verify(browser).find_elements_by_xpath("//*[(@id=\"test_selenium2library '1'\" or @name=\"test_selenium2library '1'\")]")
    ...
    def test_find_with_locator_with_quote_and_apos(self):
        finder = ElementFinder()
        browser = mock()
        finder.find(browser, "test_selenium2library \"1\" and '2'")
        verify(browser).find_elements_by_xpath(
            "//*[(@id=concat('test_selenium2library \"1\" and ', \"'\", '2', \"'\", '') or @name=concat('test_selenium2library \"1\" and ', \"'\", '2', \"'\", ''))]")
    ...
    def test_find_with_img(self):
        ...
        verify(browser).find_elements_by_xpath(
            "//img[(@id='test1' or @name='test1' or @res='test1' or @alt='test1' or @res='http://localhost/test1')]")
    ...
    def test_find_with_input(self):
        ...
        verify(browser).find_elements_by_xpath(
            "//input[(@id='test1' or @name='test1' or @value='test1' or @res='test1' or @res='http://localhost/test1')]")
    ...
    def test_find_with_radio_button_synonym(self):
        ...
        verify(browser).find_elements_by_xpath(
            "//input[@type='radio' and (@id='test1' or @name='test1' or @value='test1' or @res='test1' or @res='http://localhost/test1')]")
    ...
    def test_find_with_checkbox_synonym(self):
        ...
        verify(browser).find_elements_by_xpath(
            "//input[@type='checkbox' and (@id='test1' or @name='test1' or @value='test1' or @res='test1' or @res='http://localhost/test1')]")
    ...
    def test_find_with_file_upload_synonym(self):
        ...
        verify(browser).find_elements_by_xpath(
            "//input[@type='file' and (@id='test1' or @name='test1' or @value='test1' or @res='test1' or @res='http://localhost/test1')]")
    ...
    def test_find_with_text_field_synonym(self):
        ...
        verify(browser).find_elements_by_xpath(
            "//input[@type='text' and (@id='test1' or @name='test1' or @value='test1' or @res='test1' or @res='http://localhost/test1')]")
    ...
    def test_find_with_implicit_xpath(self):
        ...
        when(browser).find_elements_by_xpath("//*[(@test_selenium2library='1')]").thenReturn(elements)

        result = finder.find(browser, "//*[(@test_selenium2library='1')]")
        self.assertEqual(result, elements)
        result = finder.find(browser, "//*[(@test_selenium2library='1')]", tag='a')
    ...
    def test_find_by_xpath(self):
        ...
        result = finder.find(browser, "xpath=//*[(@test_selenium2library='1')]")
        self.assertEqual(result, elements)
        result = finder.find(browser, "xpath=//*[(@test_selenium2library='1')]", tag='a')
        self.assertEqual(result, [elements[1], elements[3]])
